...
# from heaviside_comp import HeavisideComp
from densityfilter_comp import DensityFilterComp
from penalization_comp import PenalizationComp
from states_comp import StatesComp
from disp_comp import DispComp
from compliance_comp import ComplianceComp
from weight_comp import WeightComp
...
class SimpGroup(Group):
    ...
    def setup(self):
        ...
        (nodes, elem) = fem_solver.get_mesh()
        ...
        self.connect('inputs_comp.force', 'compliance_comp.forces')
        ...
        # states 
        comp = StatesComp(fem_solver=fem_solver, BCid = BCid,
                          num_nodes_x=num_nodes_x, num_nodes_y=num_nodes_y,
        ...
        comp = DispComp(nDOF = nDOF, nSTATE = nSTATE)
