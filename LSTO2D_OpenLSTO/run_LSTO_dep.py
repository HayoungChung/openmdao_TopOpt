...
for i_HJ in range(0,max_loop):
    ...
    scales_F = prob['compliance_scale_comp.scale']
    scales_G = prob['constraint_scale_comp.scale']
    
    # lambdas[0] *= scales_F
    # lambdas[1] *= scales_G
    # displacements also needs scaling
